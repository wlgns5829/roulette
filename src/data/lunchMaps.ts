...
export const curatedLunchStages: StageDef[] = [
  {
    title: '벚꽃 비탈마을',
    description: '핑크 나무와 사다리, 언덕길을 따라 위로 치고 올라가는 봄빛 마을 코스입니다.',
    flavor: '벚꽃 골목 사이로 선두가 뒤바뀌는 세로형 동네 레이스 느낌으로 설계했습니다.',
    accent: '#f472b6',
  ...
  {
    title: '천공성 계단회랑',
    description: '하늘 위 신전 계단과 공중 발판을 타고 위로 오르는 고공 추격 맵입니다.',
    flavor: '구름 위 성채를 층층이 돌파하며 올라가는 긴장감을 담았습니다.',
    accent: '#60a5fa',
  ...
  {
    title: '심해 형광수로',
    description: '푸른 형광 해저 통로를 따라 위로 떠오르듯 돌파하는 수중 코스입니다.',
    flavor: '해류에 휩쓸리듯 솟구치다가 부딪히는 심해 수로 느낌입니다.',
    accent: '#22d3ee',
  ...
  {
    title: '월야 포장마차 거리',
    description: '등불과 포장마차 사이 골목을 따라 위로 파고드는 밤시장 코스입니다.',
    flavor: '좁은 야시장 골목을 비집고 올라가는 혼전형 레이스입니다.',
    accent: '#f59e0b',
  ...
  {
    title: '건초 언덕 다락길',
    description: '층층이 쌓인 언덕 발판과 사다리를 타고 위로 오르는 목가적인 코스입니다.',
    flavor: '농장 언덕을 층층이 돌파하며 추월하는 수직 플랫포머 느낌입니다.',
    accent: '#84cc16',
