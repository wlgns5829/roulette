...
const coffeeRunEntities: MapEntity[] = [
  ...
  box(11.1, 47.8, 1.15, 0.1, 0.54, '#fbbf24'),
  box(14.9, 58.6, 1.2, 0.1, -0.52, '#fbbf24'),
  ...
  spinner(12.9, 123.5, 2.8, -3.2, '#fde68a'),
  ...pegField(8.4, 46.5, 4, 3, 2.15, 2.35, '#fcd34d'),
