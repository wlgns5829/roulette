...
export const curatedLunchStages: StageDef[] = [
  {
    title: '벚꽃 비탈마을',
    description: '핑크 나무와 사다리, 언덕길을 따라 좌우로 질주하는 봄빛 마을 코스입니다.',
    flavor: '벚꽃 골목 사이로 선두가 뒤바뀌는 동네 레이스 느낌으로 설계했습니다.',
    accent: '#f472b6',
    backdrop: 'sakura-village',
    presentation: 'side-scroll',
    patternSeed: 0,
    eventPool: pool('meeting-call', 'ac-draft', 'bean-burst', 'shark-rush'),
    goalY: 156,
    zoomY: 151,
  },
  {
    title: '천공성 계단회랑',
    description: '하늘 위 신전 계단과 공중 발판을 가로지르는 고공 질주 맵입니다.',
    flavor: '구름 위 성채를 오가듯 발판 사이를 건너는 긴장감을 담았습니다.',
    accent: '#60a5fa',
    backdrop: 'sky-sanctum',
    presentation: 'side-scroll',
    patternSeed: 1,
    eventPool: pool('espresso-shot', 'meeting-call', 'bomb-burst', 'shark-rush'),
    goalY: 164,
  ...
  {
    title: '버섯광장 대혼선',
    description: '버섯 지붕과 광장 분기 구조를 닮은 복합 미로형 세로 코스입니다.',
    flavor: '북적이는 마을 한복판처럼 여러 갈래가 엉키며 추월전이 이어집니다.',
    accent: '#fb923c',
    backdrop: 'mushroom-square',
    patternSeed: 0,
    eventPool: pool('coffee-spill', 'bean-burst', 'bomb-burst', 'sugar-crash'),
    goalY: 158,
    zoomY: 153,
  },
  {
    title: '심해 형광수로',
    description: '푸른 형광 해저 통로를 따라 미끄러지듯 지나가는 수중 질주 맵입니다.',
    flavor: '해류에 휩쓸리듯 속도가 붙다가 갑자기 부딪히는 심해 수로 느낌입니다.',
    accent: '#22d3ee',
    backdrop: 'abyss-corridor',
    presentation: 'side-scroll',
    patternSeed: 2,
    eventPool: pool('ac-draft', 'shark-rush', 'bomb-burst', 'bean-burst'),
    goalY: 160,
    zoomY: 155,
  },
  {
    title: '오로라 설원마을',
    description: '눈 덮인 마을 위로 오로라가 흐르는 야간 추격전 코스입니다.',
    flavor: '차가운 길 위에서 미끄러지듯 순위가 흔들리는 겨울 마을 분위기입니다.',
    accent: '#a78bfa',
    backdrop: 'aurora-village',
    patternSeed: 3,
    eventPool: pool('ac-draft', 'meeting-call', 'sugar-crash', 'shark-rush'),
    goalY: 154,
    zoomY: 149,
  },
  {
    title: '월야 포장마차 거리',
    description: '등불과 포장마차 사이 골목을 가로지르는 밤시장 좌우 질주 코스입니다.',
    flavor: '좁은 야시장 골목처럼 부딪치고 비집고 들어가는 혼전형 레이스입니다.',
    accent: '#f59e0b',
    backdrop: 'moon-market',
    presentation: 'side-scroll',
    patternSeed: 3,
    eventPool: pool('coffee-spill', 'meeting-call', 'bomb-burst', 'shark-rush'),
    goalY: 162,
    zoomY: 157,
  },
  {
    title: '별궁 첨탑 회랑',
    description: '별빛 궁전 탑 사이를 오르내리는 몽환적인 세로 회랑 코스입니다.',
    flavor: '반짝이는 첨탑 사이로 한순간 길이 열리고 닫히는 판타지 코스입니다.',
    accent: '#67e8f9',
    backdrop: 'star-palace',
    patternSeed: 4,
    eventPool: pool('espresso-shot', 'bean-burst', 'bomb-burst', 'shark-rush'),
    goalY: 166,
    zoomY: 161,
  },
  {
    title: '건초 언덕 다락길',
    description: '층층이 쌓인 언덕 발판과 사다리를 타고 달리는 목가적인 질주 맵입니다.',
    flavor: '농장 언덕을 타고 위아래로 튀어 오르며 추월하는 플랫포머 느낌입니다.',
    accent: '#84cc16',
    backdrop: 'harvest-terrace',
    presentation: 'side-scroll',
    patternSeed: 4,
    eventPool: pool('bean-burst', 'coffee-spill', 'meeting-call', 'sugar-crash'),
    goalY: 168,
    zoomY: 163,
  },
];
