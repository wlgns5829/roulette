...
const elevatorChaosEntities: MapEntity[] = [
  ...
  movingBox(13, 136.8, 1.95, 0.11, 0, '#bae6fd', { axis: 'y', amplitude: 1.5, speed: 1.58, phase: 2.2 }),
  spinner(9.4, 56.6, 2.6, 4.6, '#22d3ee'),
  spinner(16.6, 84.6, 2.6, -4.6, '#06b6d4'),
  spinner(9.6, 112.4, 2.6, 4.8, '#0ea5e9'),
  spinner(16.4, 140.2, 2.6, -5, '#38bdf8'),
  spinner(13, 149.4, 2.15, 4.3, '#f8fafc'),
